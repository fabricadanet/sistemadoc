...
<div class="container-xl d-flex justify-content-center align-items-center ">
    ...
    <div class="page-header d-print-none">
        ...
        <p class="text-center">Cadastro de antigos associados.</p>
    </div>
</div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('cadastros.admin.store') }}">
                    ...
                    <div class="form-group col-md-4 mb-3 ">
                        ...
                        <div>
                            <input type="date" class="form-control" aria-describedby="emailHelp" placeholder="Data de Associação" name="data_associacao" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <div>
                                    <input type="text" class="form-control" placeholder="CPF somente números" name="cpf" required id="cpf">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <div>
                                    <input type="text" class="form-control" placeholder="RG somente números" name="rg" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <div>
                                <input type="text" class="form-control" placeholder="Cidade/Estado" name="naturalidade" required>
                            </div>
                        ...
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <div>
                                <input type="text" class="form-control" placeholder="Nacionalidade" name="nacionalidade" value="Brasileira" required>
                            </div>
                        </div>
                    </div>
                    <hr class="mt-2">
                    ...
                    <div class="row">
                        <div class="form-group mb-3 col-md-8">
                            ...
                            <div>
                                <input type="text" class="form-control" placeholder="Avenda/Estrada/Rua" name="logradouro" required>
                            </div>
                        </div>
                                    ...
                                    <div class="modal-body">
                                        <div>
                                            <div class="form-group mb-3 ">
                                                ...
                                                <div>
                                                    <input type="text" class="form-control" placeholder="Matrícula Funcional" name="matricula">
                                                </div>
                                            </div>
                                            <div class="form-group mb-3 ">
                                                <label class="form-label">Cidade</label>
                                            ...
                                            <div class="form-group  mb-3 ">
                                                ...
                                                <div>
                                                    <input type="date" class="form-control" aria-describedby="emailHelp" placeholder="Data de Adimissão" name="data_admissao">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 col-md-4">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div>
                                                <label class="form-check form-check form-check-inline ">
                                                    <input class="form-check-input" type="checkbox" checked="" name="funcao[]" value="Professor(a) anos iniciais">
                                                    <span class="form-check-label">Professor(a) Anos Iniciais</span>
                                                </label>
                                                <label class="form-check form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="funcao[]" value="Professor(a) educacao infanti">
                                                    <span class="form-check-label">Professor(a) Educação Infantil</span>
                                                </label>
                                                <label class="form-check form-check form-check-inline ">
                                                    <input class="form-check-input" type="checkbox" name="funcao[]" value="Professor(a) educacao especial">
                                                    <span class="form-check-label">Professor(a) Educação Especial</span>
                                                </label>
                                                <label class="form-check form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="funcao[]" value="Supervisor(a) escolar">
                                                    <span class="form-check-label">Supervisor(a) Escolar</span>
                                                </label>
                                                <label class="form-check form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="funcao[]" value="Orientador(a) educacional">
